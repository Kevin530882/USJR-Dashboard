...
<head>
    ...
    <link rel="stylesheet" href="department.css?v=1.2">
...
<aside>
    ...
    <div class="edit-panel">
        ...
        <h3 class="text-white">Edit Department</h3>
        <table>
            <tr>
                <td>ID</td>
            ...
            <tr>
                <td>College</td>
                <td><select name="editCollId" id="editCollId"></select></td>
            </tr>
            <tr>
    ...
    <script src="view-departments.js"></script>
    <script>
        function logmeout() {
            window.location.href = "../logout.php";
        }
        function back() {
            window.location.href = '../Students/student-listing.php';
        }
