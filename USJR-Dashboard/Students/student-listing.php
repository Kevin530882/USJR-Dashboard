...
<aside>
    ...
    <div id="editPanel">
        ...
        <table>
            ...
            <tr>
                <td>Last Name</td>
                <td><input type="text" name="editLastName" id="editLastName"></td>
            </tr>
            <tr>
                <td>First Name</td>
                <td><input type="text" name="editFirstName" id="editFirstName"></td>
            </tr>
            <tr>
                <td>Middle Name</td>
                <td><input type="text" name="editMidName" id="editMidName"></td>
            </tr>
            <tr>
                <td>College</td>
                <td>
                    <select name="editCollege" id="editCollege">
                    </select>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td>Year</td>
                <td><select name="editYear" id="editYear">
    ...
    <script src="student-listing.js"></script>
    <script>
        function logmeout() {
