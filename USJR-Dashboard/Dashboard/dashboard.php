...
<header>
        <div>
            <img src="../USJR1.png" alt="">
            <h1 class="text-white">UNIVERSITY OF SAN JOSE - RECOLETOS</h1>
        </div>
        <div class="user">
            <h6 class="text-white">You are logged in as: <?php echo $_SESSION['user'] ?></h6>
            <button class="btn btn-danger" onclick="logmeout()">Logout</button>
        </div>
    </header>
    <main>
    ...
    <script>
        ...
        axios.get('getstudentsdashboard.php')
            .then(function (response) {
                const data = response.data;
                const labels = data.map(item => item.collfullname);
                const numStudents = data.map(item => item.num_students);
