...
<head>
    ...
    <link rel="stylesheet" href="college.css?v=1.2">
    <title>College</title>
</head>
<body>
    <aside>
    ...
    <div class="content">
        <header>
            ...
            <h1>COLLEGE</h1>
            <button class="btn btn-primary text-white" onclick="addCollege()">Add College</button>
        </header>
    ...
    <div class="edit-panel">
        ...
        <h3 class="text-white">Edit College</h3>
        <table>
            <tr>
                <td>ID</td>
    ...
    <script src="view-colleges.js"></script>
    <script>
        function logmeout() {
            window.location.href = "../logout.php";
        }
        function addCollege() {
            window.location.href = 'add-college.php';
        }
